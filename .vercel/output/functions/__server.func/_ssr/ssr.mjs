...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CB2Mrcwa.mjs");
...
var manifest = {
	"093fbe9fe1e23d72bd0109bbb86290536086600e843ca672b7cc613fbb41b395": {
		functionName: "loadProfile_createServerFn_handler",
		importer: () => import("./workspace-BAU1E2ns.mjs")
	},
	"38e9d27e256402519ac1ea676381a4cc074afaf76a76bbafecf00f5b02dd3e03": {
		functionName: "saveWorkspaceAsset_createServerFn_handler",
		importer: () => import("./workspace-BAU1E2ns.mjs")
	},
	"51f5552fb820119e0a514ca208265578c61b02884217497e7618f9746b49794f": {
		functionName: "checkUnlock_createServerFn_handler",
		importer: () => import("./workspace-BAU1E2ns.mjs")
	},
	"660d2259743bff2cfcb01f2c7c91b27e572662697a890056662344f43b58751d": {
		functionName: "saveWorkspace_createServerFn_handler",
		importer: () => import("./workspace-BAU1E2ns.mjs")
	},
	"687797a3e0b2bfbd6298de7d11379a460c34785f69758cda4866ba980a304db6": {
		functionName: "saveProfile_createServerFn_handler",
		importer: () => import("./workspace-BAU1E2ns.mjs")
	},
	"9b57039195d044ca1a21623b669d5a36f9558f3949f3959fdb2e9f4bdcfa71ce": {
		functionName: "loadWorkspaceAssets_createServerFn_handler",
		importer: () => import("./workspace-BAU1E2ns.mjs")
	},
	"d8f25b32c763671aa1782e0faed9445b12dee6581e7cd6856e7f28527a33f530": {
		functionName: "claimAssignee_createServerFn_handler",
		importer: () => import("./workspace-BAU1E2ns.mjs")
	},
	"e043004a1e625ef71bb8a319e726e2a6574b8d211431602bf7b7c4a174566064": {
		functionName: "unlockWorkspace_createServerFn_handler",
		importer: () => import("./workspace-BAU1E2ns.mjs")
	},
	"f250419c7022b908c9f63ff8099f0bc681d9b71bf0e24647a9a9d5c2790db76e": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-YokSpP1N.mjs").then((n) => n.f).then((n) => n.t),
