...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D7UYpPR9.js
var router_D7UYpPR9_exports = /* @__PURE__ */ __exportAll({
	a: () => getBaseURL,
	getRouter: () => getRouter,
	i: () => PACKAGE_VERSION,
	n: () => GROK_PROVIDERS,
...
var styles_default = "/assets/styles-BgGSdoGY.css";
var APP_NAME = "Ledger";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A calm kanban board for work in motion."
			},
			{
...
var $$splitComponentImporter$1 = () => import("./routes-CdzhOD_y.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-DEZ1zpSc.mjs");
...
//#endregion
export { router_D7UYpPR9_exports as a, getBaseURL as i, GROK_PROVIDERS as n, PACKAGE_VERSION as r, GENERIC_OAUTH_ERROR_CODES as t };
