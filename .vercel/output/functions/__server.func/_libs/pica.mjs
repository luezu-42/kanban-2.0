...
//#region node_modules/pica/dist/pica.js
var require_pica = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	...
	(function(f) {
		...
		return (function() {
			...
			3: [function(_dereq_, module$3, exports$3) {
				"use strict";
				module$3.exports = "";
			}, {}],
			...
			5: [function(_dereq_, module$5, exports$5) {
				"use strict";
				...
				module$5.exports = function resize(options) {
					var src = options.src;
			...
			6: [function(_dereq_, module$6, exports$6) {
				"use strict";
				...
				module$6.exports = function resizeFilterGen(quality, srcSize, destSize, scale, offset) {
			...
			7: [function(_dereq_, module$7, exports$7) {
				"use strict";
				module$7.exports = [
					{
						win: .5,
			...
			8: [function(_dereq_, module$8, exports$8) {
				"use strict";
				var createFilters = _dereq_("./resize_filter_gen");
				function resetAlpha(dst, width, height) {
					var ptr = 3, len = width * height * 4 | 0;
				...
				module$8.exports = function resize_wasm(options) {
					var src = options.src;
					var srcW = options.width;
					var srcH = options.height;
					var destW = options.toWidth;
					...
					var alpha = options.alpha || false;
					var filtersX = createFilters(quality, srcW, destW, scaleX, offsetX), filtersY = createFilters(quality, srcH, destH, scaleY, offsetY);
					var tmp_offset = this.__align(0 + Math.max(src.byteLength, dest.byteLength));
					...
					(instance.exports.convolveHV || instance.exports._convolveHV)(filtersX_offset, filtersY_offset, tmp_offset, srcW, srcH, destW, destH);
					new Uint32Array(dest.buffer).set(new Uint32Array(this.__memory.buffer, 0, destH * destW));
					if (!alpha) resetAlpha(dest, destW, destH);
					return dest;
				};
			}, { "./resize_filter_gen": 6 }],
			9: [function(_dereq_, module$9, exports$9) {
				"use strict";
				module$9.exports = {
					name: "unsharp_mask",
			...
			10: [function(_dereq_, module$10, exports$10) {
				"use strict";
				...
				module$10.exports = function unsharp(img, width, height, amount, radius, threshold) {
					var v1, v2, vmul;
					var diff, iTimes4;
					...
					var amountFp = amount / 100 * 4096 + .5 | 0;
			...
			11: [function(_dereq_, module$11, exports$11) {
				"use strict";
				module$11.exports = function unsharp(img, width, height, amount, radius, threshold) {
					if (amount === 0 || radius < .5) return;
					if (radius > 2) radius = 2;
					...
					var instance = this.__instance("unsharp_mask", img_bytes_cnt + hsv_bytes_cnt + blur_bytes_cnt * 2 + blur_line_byte_cnt + blur_coeffs_byte_cnt, { exp: Math.exp });
			...
			13: [function(_dereq_, module$13, exports$13) {
				...
				module$13.exports = Pool;
			}, {}],
			14: [function(_dereq_, module$14, exports$14) {
				"use strict";
				var MIN_INNER_TILE_SIZE = 2;
				module$14.exports = function createStages(fromWidth, fromHeight, toWidth, toHeight, srcTileSize, destTileBorder) {
			...
			15: [function(_dereq_, module$15, exports$15) {
				"use strict";
				...
				module$15.exports = function createRegions(options) {
			...
			16: [function(_dereq_, module$16, exports$16) {
				"use strict";
				function objClass(obj) {
					return Object.prototype.toString.call(obj);
				}
				module$16.exports.isCanvas = function isCanvas(element) {
					var cname = objClass(element);
					return cname === "[object HTMLCanvasElement]" || cname === "[object OffscreenCanvas]" || cname === "[object Canvas]";
				};
				module$16.exports.isImage = function isImage(element) {
					return objClass(element) === "[object HTMLImageElement]";
				};
				module$16.exports.isImageBitmap = function isImageBitmap(element) {
					return objClass(element) === "[object ImageBitmap]";
				};
				module$16.exports.limiter = function limiter(concurrency) {
					var active = 0, queue = [];
					function roll() {
				...
				module$16.exports.cib_quality_name = function cib_quality_name(num) {
					switch (num) {
				...
				module$16.exports.cib_support = function cib_support(createCanvas) {
				...
				module$16.exports.worker_offscreen_canvas_support = function worker_offscreen_canvas_support() {
					return new Promise(function(resolve, reject) {
						...
						function workerPayload(self) {
							...
							Promise.resolve().then(function() {
								...
								canvas.getContext("2d").rect(0, 0, 1, 1);
				...
				module$16.exports.can_use_canvas = function can_use_canvas(createCanvas) {
					var usable = false;
					try {
						var ctx = createCanvas(2, 1).getContext("2d");
				...
				module$16.exports.cib_can_use_region = function cib_can_use_region() {
			...
			17: [function(_dereq_, module$17, exports$17) {
				"use strict";
				module$17.exports = function() {
					...
					onmessage = function onmessage(ev) {
						...
						if (!tileOpts.src && tileOpts.srcBitmap) {
							...
							var ctx = canvas.getContext("2d", { alpha: Boolean(tileOpts.alpha) });
						...
						if (returnBitmap) {
							...
							_canvas.getContext("2d", { alpha: Boolean(tileOpts.alpha) }).putImageData(toImageData, 0, 0);
							createImageBitmap(_canvas).then(function(bitmap) {
								postMessage({ bitmap }, [bitmap]);
							});
						} else postMessage({ data }, [data.buffer]);
					};
				};
			}, { "./mathlib": 1 }],
			18: [function(_dereq_, module$18, exports$18) {
				...
				module$18.exports = blurMono16;
			}, {}],
			19: [function(_dereq_, module$19, exports$19) {
				if (typeof Object.create === "function") module$19.exports = function inherits(ctor, superCtor) {
					if (superCtor) {
				...
				else module$19.exports = function inherits(ctor, superCtor) {
					if (superCtor) {
						ctor.super_ = superCtor;
			...
			20: [function(_dereq_, module$20, exports$20) {
				"use strict";
				...
				MultiMath.prototype.use = function(module$21) {
					this.__modules[module$21.name] = module$21;
					if (this.options.wasm && this.has_wasm() && module$21.wasm_fn) this[module$21.name] = module$21.wasm_fn;
					else this[module$21.name] = module$21.fn;
					return this;
				};
				MultiMath.prototype.init = function() {
					...
					this.__init_promise = Promise.all(Object.keys(self.__modules).map(function(name) {
						var module$22 = self.__modules[name];
						if (!self.options.wasm || !self.has_wasm() || !module$22.wasm_fn) return null;
						if (self.__wasm[name]) return null;
						return WebAssembly.compile(self.__base64decode(module$22.wasm_src)).then(function(m) {
							self.__wasm[name] = m;
						});
					})).then(function() {
						return self;
				...
				MultiMath.prototype.__reallocate = function mem_grow_to(bytes) {
					if (!this.__memory) {
						this.__memory = new WebAssembly.Memory({ initial: Math.ceil(bytes / 65536) });
				...
				MultiMath.prototype.__instance = function instance(name, memsize, env_extra) {
					...
					if (!this.__wasm[name]) {
						var module$23 = this.__modules[name];
						this.__wasm[name] = new WebAssembly.Module(this.__base64decode(module$23.wasm_src));
					}
				...
				module$20.exports = MultiMath;
			}, {
				"./lib/base64decode": 21,
				"./lib/wa_detect": 22,
				"object-assign": 23
			}],
			21: [function(_dereq_, module$24, exports$21) {
				"use strict";
				var BASE64_MAP = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
				module$24.exports = function base64decode(str) {
			...
			22: [function(_dereq_, module$25, exports$22) {
				"use strict";
				var wa;
				module$25.exports = function hasWebAssembly() {
					...
					try {
						...
						var module$26 = new WebAssembly.Module(bin);
						if (new WebAssembly.Instance(module$26, {}).exports.test(4) !== 0) wa = true;
						return wa;
					} catch (__) {}
					return wa;
				};
			}, {}],
			23: [function(_dereq_, module$27, exports$23) {
				/*
				object-assign
				(c) Sindre Sorhus
				@license MIT
				*/
				...
				module$27.exports = shouldUseNative() ? Object.assign : function(target, source) {
					var from;
			...
			24: [function(_dereq_, module$28, exports$24) {
				var bundleFn = arguments[3];
				var sources = arguments[4];
				var cache = arguments[5];
				var stringify = JSON.stringify;
				module$28.exports = function(fn, options) {
					var wkey;
			...
			"/index.js": [function(_dereq_, module$29, exports$25) {
				"use strict";
				...
				Pica.prototype.init = function() {
					...
					if (typeof ImageData !== "undefined" && typeof Uint8ClampedArray !== "undefined") try {
						new ImageData(/* @__PURE__ */ new Uint8ClampedArray(400), 10, 10);
					...
					if (features.indexOf("ww") >= 0) {
						if (typeof window !== "undefined" && "Worker" in window) try {
							_dereq_("webworkify")(function() {}).terminate();
				...
				Pica.prototype.__invokeResize = function(tileOpts, opts) {
					...
					return Promise.resolve().then(function() {
						if (!_this2.features.ww) return { data: _this2.__mathlib.resizeAndUnsharp(tileOpts, opts.__mathCache) };
						return new Promise(function(resolve, reject) {
				...
				Pica.prototype.__landTileData = function(tile, result, stageEnv) {
					...
					if (CAN_NEW_IMAGE_DATA) toImageData = new ImageData(new Uint8ClampedArray(result.data), tile.toWidth, tile.toHeight);
					else {
						toImageData = stageEnv.toCtx.createImageData(tile.toWidth, tile.toHeight);
						if (toImageData.data.set) toImageData.data.set(result.data);
						else for (var i = toImageData.data.length - 1; i >= 0; i--) toImageData.data[i] = result.data[i];
					}
					this.debug("Draw tile");
					if (NEED_SAFARI_FIX) stageEnv.toCtx.putImageData(toImageData, tile.toX, tile.toY, tile.toInnerX - tile.toX, tile.toInnerY - tile.toY, tile.toInnerWidth + 1e-5, tile.toInnerHeight + 1e-5);
				...
				Pica.prototype.__processStages = function(stages, from, to, opts) {
					var _this4 = this;
					if (opts.canceled) return opts.cancelToken;
					var _stages$shift2 = _slicedToArray(stages.shift(), 2), toWidth = _stages$shift2[0], toHeight = _stages$shift2[1];
					...
					var tmpCanvas;
					if (!isLastStage) tmpCanvas = this.options.createCanvas(toWidth, toHeight);
				...
				Pica.prototype.resize = function(from, to, options) {
					...
					if (!isNaN(options)) opts = assign(opts, { quality: options });
					...
					opts.canceled = false;
					if (opts.cancelToken) opts.cancelToken = opts.cancelToken.then(function(data) {
						opts.canceled = true;
						throw data;
					}, function(err) {
						opts.canceled = true;
					...
					return this.init().then(function() {
						if (opts.canceled) return opts.cancelToken;
						if (_this6.features.cib) return _this6.__resizeViaCreateImageBitmap(from, to, opts);
						if (!CAN_USE_CANVAS_GET_IMAGE_DATA) {
							var err = /* @__PURE__ */ new Error("Pica: cannot use getImageData on canvas, make sure fingerprinting protection isn't enabled");
